...
The only function of these APIs and adapters is to parse topologies, event schedules and traffic matrices generated by the core library and easily import them in the desired target simulator. FNSS adapters and APIs can be downloaded `here <http://fnss.github.com/>`_.
...
.. highlights::
    ...
    `A Toolchain for Symplifying Network Simulation Setup <http://fnss.github.com/publications/fnss-simutools13.pdf>`_,
