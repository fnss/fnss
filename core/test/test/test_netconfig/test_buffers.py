...
class Test(unittest.TestCase):
    ...
    def test_buffers_size_link_bandwidth_default_size(self):
        ...
        self.assertEquals(topo.edge[0][1]['buffer'], 1000000)
        self.assertEquals(topo.edge[1][2]['buffer'], 2000000)
        self.assertEquals(topo.edge[2][3]['buffer'], 10)
        fnss.clear_buffer_sizes(topo)
        self.assertTrue('capacity' not in topo.edge[2][3])
