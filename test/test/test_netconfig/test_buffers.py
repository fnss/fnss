...
class Test(unittest.TestCase):
    ...
    def test_buffers_size_link_bandwidth_default_size(self):
        ...
        self.assertEqual(topo.graph['buffer_unit'], 'bytes')
        self.assertEqual(topo.adj[0][1]['buffer'], 1000000)
        self.assertEqual(topo.adj[1][2]['buffer'], 2000000)
        self.assertEqual(topo.adj[2][3]['buffer'], 10)
